    ...
    internal class IAP : MenuBase
    {
        protected override void GetGui()
        {
            ...
            if (this.Button("Initialize GPBL"))
            {
                ...
                LogView.AddLog("Initialized GPBL");
            }
#else
